...
namespace DVLD_WindowsForm
{
    public partial class Manage_People : Form
    {
        ...
        {
            dtPeople = clsPersonBusiness.GetAllPeople();
        ...
        {
            _RefreshPeopleList();  // load data table  & set default view
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            // dtPeopleView.Rowfilter = $"{filter by} = {txtFilter.Text}"

            // finction(ref dtPeopleView)
            _RefreshPeopleList();
