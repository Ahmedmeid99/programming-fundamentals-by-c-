...
{
    public partial class ManageWrittenTestForm : Form
    {
        ...
        int TestTypeID = (int)GlobalEnums.enTestType.WrittenTest;
        ...
        public ManageWrittenTestForm(int DLApplicationID)
        {
            InitializeComponent();
        ...
        private void ManageWrittenTestForm_Load(object sender, EventArgs e)
        {
            dgvAppointmentsList.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
        }
        private void _RefreshTestAppointmentsList()
        {
            dtTestAppointments = clsTestAppointment.GetAllTestAppointments(_DLApplication.LocaLDLApplicationID, (int) GlobalEnums.enTestType.WrittenTest);
